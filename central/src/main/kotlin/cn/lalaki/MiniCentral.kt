...
open class MiniCentral : Plugin<Project>, Action<Project> {
    ...
    override fun execute(after: Project) {
        after.run {
            ...
            extensions.findByType(PublishingExtension::class.java)?.apply {
                findAllRepositories(repositories, ext)
                if (ext.repository.get().isEmpty()) {
    ...
    private fun findAllRepositories(repositories: RepositoryHandler, ext: MiniCentralExtension) {
